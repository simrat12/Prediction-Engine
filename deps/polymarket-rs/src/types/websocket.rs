...
pub struct PriceChange {
    ...
    #[serde(with = "rust_decimal::serde::str")]
    pub size: Decimal,
    /// Current best bid for this asset (top-of-book after this update)
    #[serde(default, with = "crate::types::serde_helpers::option_decimal_from_str")]
    pub best_bid: Option<Decimal>,
    /// Current best ask for this asset (top-of-book after this update)
    #[serde(default, with = "crate::types::serde_helpers::option_decimal_from_str")]
